...
{
    public partial class Print1Page : ContentPage
    {
        ...
        public Print1Page(IPeripheral peripheral)
        {
           ...
           // mystack.Enqueue(10);
            ...
            //PrintPageViewModel numberz = new PrintPageViewModel(peripheral);
        ...
        public static void OnPainting(object sender, SKPaintSurfaceEventArgs e)
        {
            ...
            decimal max = PrintPageViewModel.Ttrip1001;
            if (max <= 1) max = 10;
            //max = max ;
            ...
            //if ((int)(PrintPageViewModel.Tinstant1 * 20) != (int)(lasttt * 20))

            if (tick==1)
            {
                mystack.Enqueue(PrintPageViewModel.Tinstant1);
                tick = 0;
            }
